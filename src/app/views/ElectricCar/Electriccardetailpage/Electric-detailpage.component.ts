...
@Component({
  selector: 'app-Electriccardetailpage',
  templateUrl: './Electric-detailpage.component.html',
  styleUrls: ['./Electric-detailpage.component.scss']
})
export class ElectricCardetailpageComponent implements OnInit{
